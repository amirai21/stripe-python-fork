...
from ai21 import api_requestor, connect_api_base, error
from ai21.six.moves.urllib.parse import urlencode
...
class OAuth(object):
    ...
    def _set_client_id(params):
        ...
        raise error.AuthenticationError(
            ...
            '"ai21.client_id = <CLIENT-ID>"). You can find your client_ids '
            "in your Stripe dashboard at "
            "https://dashboard.stripe.com/account/applications/settings, "
            "after registering your account as a platform. See "
            "https://stripe.com/docs/connect/standalone-accounts for details, "
            "or email support@ai21.com if you have any questions."
        )
