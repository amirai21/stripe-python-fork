...
class MultipartDataGenerator(object):
    ...
    def add_params(self, params):
        ...
        params = dict(ai21.api_requestor._api_encode(params))

        for key, value in ai21.six.iteritems(params):
            if value is None:
                continue
            ...
            if hasattr(value, "read"):
                ...
                if hasattr(value, "name"):
                    ...
                    filename = ai21.six.text_type(value.name)
    ...
    def _write(self, value):
        if isinstance(value, ai21.six.binary_type):
            array = bytearray(value)
        elif isinstance(value, ai21.six.text_type):
