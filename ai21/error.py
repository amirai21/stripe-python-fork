...
import ai21
from ai21.six import python_2_unicode_compatible
...
class StripeError(Exception):
        ...
        if http_body and hasattr(http_body, "decode"):
            try:
                ...
                http_body = (
                    ...
                    "Please report to support@ai21.com>"
                )
    ...
    def construct_error_object(self):
        ...
        return ai21.api_resources.error_object.ErrorObject.construct_from(
            self.json_body["error"], ai21.api_key
        )
